  ...
  return (
    <section className="mt-5" aria-label="未来七日安排">
      ...
      {selectedTodos.length === 0 ? (
        <div className="mt-3 rounded-[var(--radius-panel)] border border-dashed border-[var(--border-strong)] bg-white/55 px-5 py-10 text-center">
