...
export type AgentScenarioName = 'success' | 'timeout' | 'readOnlyTimeout' | 'readOnlySuccess' | 'deleteTimeout' | 'validationError' | 'confirmationRequired' | 'disconnect' | 'readOnlyDisconnect'
